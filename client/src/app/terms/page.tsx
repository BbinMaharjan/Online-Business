    ...
    <Container maxWidth="xl">
      <Box sx={{ py: 6 }}>
        ...
        <Paper elevation={1} sx={{ p: { xs: 3, md: 5 } }}>
          ...
          <section sx={{ mb: 5 }}>
            <Typography variant="h5" sx={{ fontWeight: 700, mb: 2 }}>1. Account Registration</Typography>
          ...
          <section sx={{ mb: 5 }}>
            <Typography variant="h5" sx={{ fontWeight: 700, mb: 2 }}>2. Orders and Payments</Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
          ...
          <section sx={{ mb: 5 }}>
            <Typography variant="h5" sx={{ fontWeight: 700, mb: 2 }}>3. Shipping and Delivery</Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
          ...
          <section sx={{ mb: 5 }}>
            <Typography variant="h5" sx={{ fontWeight: 700, mb: 2 }}>4. Returns and Refunds</Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
          ...
          <section sx={{ mb: 5 }}>
            <Typography variant="h5" sx={{ fontWeight: 700, mb: 2 }}>5. Intellectual Property</Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
          ...
          <section sx={{ mb: 5 }}>
            <Typography variant="h5" sx={{ fontWeight: 700, mb: 2 }}>6. User Content</Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
          ...
          <section sx={{ mb: 5 }}>
            <Typography variant="h5" sx={{ fontWeight: 700, mb: 2 }}>7. Prohibited Activities</Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
              You agree not to:
            </Typography>
          ...
          <section sx={{ mb: 5 }}>
            <Typography variant="h5" sx={{ fontWeight: 700, mb: 2 }}>8. Disclaimers and Limitation of Liability</Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
          ...
          <section sx={{ mb: 5 }}>
            <Typography variant="h5" sx={{ fontWeight: 700, mb: 2 }}>9. Indemnification</Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
          ...
          <section sx={{ mb: 5 }}>
            <Typography variant="h5" sx={{ fontWeight: 700, mb: 2 }}>10. Governing Law and Disputes</Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
          ...
          <section sx={{ mb: 5 }}>
            <Typography variant="h5" sx={{ fontWeight: 700, mb: 2 }}>11. Changes to Terms</Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
          ...
          <section sx={{ mb: 5 }}>
            <Typography variant="h5" sx={{ fontWeight: 700, mb: 2 }}>12. Contact Information</Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
              If you have questions about these Terms, please contact us at:
            </Typography>
            <Typography variant="body1" sx={{ whiteSpace: "pre-line" }}>
              Storefront Legal Department
              123 Commerce Street
